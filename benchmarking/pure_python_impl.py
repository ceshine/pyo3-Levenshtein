"""Python implementaiton of the Levenshtein distance

Adapted from [toastdriven/pylev](https://github.com/toastdriven/pylev)
"""
...
def wf_levenshtein(string_1: str, string_2: str):
    """Calculates the Levenshtein distance between two strings.
